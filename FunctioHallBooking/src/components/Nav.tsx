        ...
        <div>
            <nav className="navbar navbar-dark sticky-top bg-dark">
                <div className="container-fluid mx-3">
                    ...
                    <span className="text-info text-decoration-underline  fs-6 filter " onClick={() => { fetchlocation(); setmodal(true) }}>Filter</span>
                    <Modal show={modal} centered>
                        ...
                        <Modal.Body>
                            ...
                            Date:<input type="date" className="form-control m-1" onChange={(e) => { setpriceFilter({ date: e.target.value }) }} />
                            State:<select className=" form-select btn-dark m-1" onChange={(event) => setpriceFilter({ state: event.target.value })}>
